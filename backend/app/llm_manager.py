    ...
    def _build_prompt(self, context: str, user_message: str, use_external_knowledge: bool, chat_history: str, role: str, tone: str):
        ...
        if use_external_knowledge:
            system_content = (
                ...
                "- You MUST answer every question completely and confidently.\n"
                "- You are REQUIRED to provide an answer even if the Context does not contain relevant information.\n"
                "- Under NO circumstances may you respond with phrases like 'I don't know', 'I have no information', 'not in the context', or 'I cannot find that'.\n"
