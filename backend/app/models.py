...
class Bot(Base):
    ...
    header_bg_color = Column(String, nullable=True, default="#292929")
    header_text_color = Column(String, nullable=True, default="#efebeb")
    chat_text_color = Column(String, nullable=True, default="#1F2937")
    user_text_color = Column(String, nullable=True, default="#171616")
    button_color = Column(String, nullable=True, default="#0f0f0f")
    button_text_color = Column(String, nullable=True, default="#faf9f9")
    timestamp_color = Column(String, nullable=True, default="#1F2937")
...
class ChatMessage(Base):
    ...
    # LLM-derived flags for analytics and processing
    is_greeting = Column(Boolean, default=False, nullable=False)
