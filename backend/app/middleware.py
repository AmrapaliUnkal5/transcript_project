...
class RoleBasedAccessMiddleware(BaseHTTPMiddleware):
    ...
    async def dispatch(self, request: Request, call_next):
        try:
            ...
            EXEMPT_ENDPOINTS = ["/auth/google","/login", "/register", "/forgot-password", "/reset-password","/uploads_bot/","/uploads", "/scrape", "/get_nodes","/captcha","/validate-captcha","/verify-email","/resend-verification-email", "/subscriptionplans"] 
