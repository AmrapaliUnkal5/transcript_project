        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          <div className="rounded-md shadow-sm -space-y-px">
            <div>
              ...
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center">
                  <Building2 className="h-5 w-5 text-gray-400" style={{ zIndex: '9' }}/>
                </div>
                <input
                  id="company_name"
                  name="company_name"
            ...
            <div>
              ...
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center">
                  <Braces className="h-5 w-5 text-gray-400" style={{ zIndex: '9' }}/>
                </div>
                <input
                  id="website"
                  name="website"
            ...
            <div>
              ...
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center">
                  <User className="h-5 w-5 text-gray-400" style={{ zIndex: '9' }}/>
                </div>
                <input
                  id="name"
                  name="name"
